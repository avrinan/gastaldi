//
//  CFE+CoreDataProperties.swift
//  Gastaldi
//
//  Created by Daniel Bonini on 8/25/16.
...
extension CFE {
    ...
    @NSManaged var fechaCFE: NSDate?
    @NSManaged var fechaDesde: NSDate?
    @NSManaged var fechaHasta: NSDate?
